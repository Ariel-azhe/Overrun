...
/* Writes to file dataB the name of student, the null byte, and lastly 
   the address of the grade B line in the main function
   in machine language. Returns 0.  */
FILE *psFILE;
int main(void)
{
    int i;
    unsigned long ulData = 0x400890;    /* Address of B instruciton in main()*/
    ...
    /* Overwrite getName's stored x30 w/ instruction to get a B in main()*/
